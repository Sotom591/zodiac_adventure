...
cap = Constellation.create(zodiac_sign_id: 1, description: "Capricornus has been recognized as a goat since Babylonian and Chaldean times. Usually, it is depicted as a goat with a fish tail, which might relate to a story about the god Pan. Pan, fleeing a monster called Typhon, jumed into the river Nile. The part of him that was below water turned into a fish, while the rest of him above water, stayed as a goat", sky_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/CapricornusCC.jpg/256px-CapricornusCC.jpg")

aqu = Constellation.create(zodiac_sign_id: 2, description: "Aquarius is a rather faint constellation which would not be famous if it weren’t part of the Zodiac. Aquarius, as its name suggests is universally associated with water. In most cultures, it is drawn as a man pouring water from a bucket. This may arise from the fact that the Sun enters Aquarius in early winter when the rainy season begins in many parts of the world", sky_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/AquariusCC.jpg/256px-AquariusCC.jpg")

pis = Constellation.create(zodiac_sign_id: 3, description: "Pisces constellation is of Babylonian origin. The Babylonians saw it as a pair of fish joined by a cord. The constellation is usually associated with the Roman myth of Venus and Cupid, who tied themselves with a rope and transformed into fish to escape the monster Typhon. The star Alpha Piscium, also known by the traditional name Alrescha (“the cord” in Arabic) marks the knot of the rope.", sky_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/PiscesCC.jpg/256px-PiscesCC.jpg")

ari = Constellation.create(zodiac_sign_id: 4, description: "The Babylonians, the Egyptians, the Greeks and the Persians all agreed on this constellaton’s name of the Ram. In Greek mythology, the story of the Ram begins in Thessaly. The King of Thessaly had two children named Phrixus and Helle who were beaten by their stepmother. The god Hermes beame angered by this and sent a ram to carry the two children to safety. Tragically, Helle lost her grip and tumbled from the ram into the narrow strip of water between Europe and Asia, now called Hellespont in her honor. Phrixus, on the other hand, arrived safely to the shores of the Black Sea where he sacrificed the ram and gave its fleece to a sleepless dragon for safe-keeping. Later, Jason and his intrepid Argonauts recovered the prized fleece and returned it to Thessaly", sky_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/AriesCC.jpg/256px-AriesCC.jpg")

tau = Constellation.create(zodiac_sign_id: 5, description: "Taurus is one of the many animals hunted by Orion, the Hunter.
...
The Egyptians saw the constellation instead as their god Osiris while the Chinese caled it alternatively the “White Tiger” or the “Great Bridge.", sky_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/TaurusCC.jpg/256px-TaurusCC.jpg")

gem = Constellation.create(zodiac_sign_id: 6, description: "Castor and Pollux, the “twins” of Gemini, were Greek heroes. They were among the men Jason led on his voyages on the Argo", sky_url: "https://www.google.com/sky/#latitude=-13.595846835881353&longitude=160.27958074926153&zoom=4&Spitzer=0.00&ChandraXO=0.00&Galex=0.00&IRAS=0.00&WMAP=0.00&Cassini=0.00&slide=3&mI=1&oI=1")

can = Constellation.create(zodiac_sign_id: 7, description: " Cancer, the Crab, plays a minor role in the Twelve Labors of Hercules. While Hercules was busy fighting the multi-headed monster, Hydra, the goddess Hera, who did not like Hercules, sent the Crab to distract him. Cancer grabbed onto the hero’s toe with its claws, but barely breaking the rhythm of his great battle with Hydra, Hercules crushed the crab with his foot. Hera, grateful for the little crustacean’s heroic but pitiful effort, gave it a place in the sky.", sky_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/GeminiCC.jpg/280px-GeminiCC.jpg")

le = Constellation.create(zodiac_sign_id: 8, description: "Leo is the Nemean Lion which was killed by Hercules on one of his great quests. Legend says that the lion had a hide that could not punctured by iron, bronze or stone. Since he couldn’t reason with the ferocious beast, Hercules strangled it to death and the local people were very grateful.
  ...
  You can find Leo in the sky by looking for the “sickle” starting at Regulus (Alpha Leonis) and following the backwards question mark. To find Regulus, use the Big Dipper as described on the Ursa Major Page.", sky_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/LeoCC.jpg/256px-LeoCC.jpg")

vir = Constellation.create(zodiac_sign_id: 9, description: "Virgo constellation lies in the southern sky. Its name means “virgin” in Latin. Virgo is one of the 12 zodiac constellations, first catalogued by the Greek astronomer Ptolemy in the 2nd century. It contains Spica, one of the brightest stars in the night sky. It also contains the autumn equinox point, which lies close to the star Beta Virginis. This is one of the two points in the sky (the other being in the constellation Pisces) where the celestial equator intersects with the ecliptic. Virgo is the second largest constellation in the sky. The only constellation larger in size is Hydra", sky_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/VirgoCC.jpg/256px-VirgoCC.jpg")

lib = Constellation.create(zodiac_sign_id: 10, description: "The constellation’s name means “the weighing scales” in Latin, and Libra is usually depicted as the scales held by the Greek goddess of justice Dike (or Astraea), represented by the neighbouring Virgo constellation. Libra is the only zodiac constellation that represents an object, not an animal or a character from mythology.",sky_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/LibraCC.jpg/256px-LibraCC.jpg")

sco = Constellation.create(zodiac_sign_id: 11, description: " Scorpius is the beast which finally killed the Great Hunter, Orion",sky_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/ScorpiusCC.jpg/256px-ScorpiusCC.jpg")

sag = Constellation.create(zodiac_sign_id: 12, description: "The center of our galaxy, the Milky Way, lies in the direction of Sagittarius. It is believed to be about 29,000 light years away from us. The Sun orbits around the Milky Way once every 200 million years at a speed of 220 kilometers per second! What is at the center of the galaxy? No one really knows yet, but it appears that there might be a giant black hole there with a mass about a million times greater that the Sun",sky_url: 
    "https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/SagittariusCC.jpg/250px-SagittariusCC.jpg")
