...
Constellation.create(zodiac_sign_id: 6, description: "Castor and Pollux, the “twins” of Gemini, were Greek heroes. They were among the men Jason led on his voyages on the Argo", sky_url: "https://www.google.com/sky/#latitude=-13.595846835881353&longitude=160.27958074926153&zoom=4&Spitzer=0.00&ChandraXO=0.00&Galex=0.00&IRAS=0.00&WMAP=0.00&Cassini=0.00&slide=3&mI=1&oI=1")

Constellation.create(zodiac_sign_id: 7, description: " Cancer, the Crab, plays a minor role in the Twelve Labors of Hercules. While Hercules was busy fighting the multi-headed monster, Hydra, the goddess Hera, who did not like Hercules, sent the Crab to distract him. Cancer grabbed onto the hero’s toe with its claws, but barely breaking the rhythm of his great battle with Hydra, Hercules crushed the crab with his foot. Hera, grateful for the little crustacean’s heroic but pitiful effort, gave it a place in the sky.", sky_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/GeminiCC.jpg/280px-GeminiCC.jpg")

Constellation.create(zodiac_sign_id: 8, description: "Leo is the Nemean Lion which was killed by Hercules on one of his great quests. Legend says that the lion had a hide that could not punctured by iron, bronze or stone. Since he couldn’t reason with the ferocious beast, Hercules strangled it to death and the local people were very grateful.
